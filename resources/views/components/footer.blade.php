                ...
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i
                                    class="fas fa-copyright text-light me-2"></i>Easy Go Airport Transfers</a>, All right
                            reserved.</span>
                    </div>
                    <div class="col-md-6 text-center text-md-end text-body">
                        Designed & Developed By <a class="border-bottom text-white" target="_blank" href="https://jeyit.solutions/">Jey IT Solutions London LTD</a>
                    </div>
                </div>
            </div>
        </div>
